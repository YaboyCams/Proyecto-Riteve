...
def configuracion():
    ...
    def guardar_config():
        if num_lineas.get() and combo_horas1.get() and combo_horas2.get() and mins_revision.get() and max_dias.get() and num_fallas.get() and percent_iva.get() and entry1.get() and entry2.get and entry3.get() and entry4.get() and entry5.get() and entry6.get() and entry7.get() and entry8.get():
            if int(num_lineas.get()) < len(colas_espera):
                messagebox.showerror("","No se puede disminuir el número de filas en este momento.") 
                return
...
#?============================================================= Acerca de ==================================================================================================================================
def creditos():
    agradecimientos = Toplevel()
    agradecimientos.geometry("700x300")
    agradecimientos.title("Acerca de")
    
    tit = Label(agradecimientos, text = "Acerca del programa", font = ("Times New Roman", 20), relief= SOLID, width = 21)
    tit.pack(side = TOP, pady = 10, anchor = CENTER)
    
    nom = Label(agradecimientos, text = "Nombre del programa:", font = ("Times New Roman", 13,"bold"))
    nom.place(x = 10, y = 60)
    nombre= Label(agradecimientos, text = "Proyecto 3: Revision Técnica de Vehículos (RETEVE)", font = ("Times New Roman", 13))
    nombre.place(x = 200, y = 60)
    
    ver = Label(agradecimientos, text = "Versión:", font = ("Times New Roman", 13, "bold"))
    ver.place(x = 10, y = 90)
    version = Label(agradecimientos, text = "10.0", font = ("Times New Roman", 13))
    version.place(x = 200, y = 90)
    
    crea = Label(agradecimientos, text = "Fecha de creación:", font = ("Times New Roman", 13, "bold"))
    crea.place(x = 10, y = 120)
    fecha_creacion = Label(agradecimientos, text = "30/5/2023", font = ("Times New Roman", 13))
    fecha_creacion.place(x = 200, y = 120)
    
    autor = Label(agradecimientos, text = "Autores:", font = ("Times New Roman", 13, "bold"))
    autor.place(x = 10, y = 150)
    autores = Label(agradecimientos, text = "Camilo Allón Quesada y Víctor Esteban Azofeifa Portuguez", font = ("Times New Roman", 13))
    autores.place(x = 200, y = 150)
    agradecimientos.mainloop()
    
#?============================================================ Ayuda ======================================================================================================================================
def ayuda():
    startfile("manual_de_usuario_reteve.pdf")
#?============================================================= Menú Principal ====================================================================================================================
...
Ayuda = Button(reteve_principal,text='Ayuda',font=('Times New Roman', 10),bg = "snow",width = 16, height = 3, command = ayuda)
Ayuda.place(x = 20, y = 460)

Acerca_de = Button(reteve_principal,text='Acerca de',font=('Times New Roman', 10),bg = "snow",width = 16, height = 3, command = creditos)
